...
const KO_MATCHES = [{"r":"32es de Finale","d":"28/06","matchups":[{"id":"R32_1","t1":{"src":"1A"},"t2":{"src":"3CDE"}},{"id":"R32_2","t1":{"src":"2A"},"t2":{"src":"2B"}}]},{"r":"32es de Finale","d":"29/06","matchups":[{"id":"R32_3","t1":{"src":"1B"},"t2":{"src":"3ACD"}},{"id":"R32_4","t1":{"src":"1C"},"t2":{"src":"3ABF"}}]},{"r":"32es de Finale","d":"30/06","matchups":[{"id":"R32_5","t1":{"src":"2C"},"t2":{"src":"2D"}},{"id":"R32_6","t1":{"src":"1D"},"t2":{"src":"3BEF"}}]},{"r":"32es de Finale","d":"01/07","matchups":[{"id":"R32_7","t1":{"src":"1E"},"t2":{"src":"3CDG"}},{"id":"R32_8","t1":{"src":"2E"},"t2":{"src":"2F"}}]},{"r":"32es de Finale","d":"02/07","matchups":[{"id":"R32_9","t1":{"src":"1F"},"t2":{"src":"3BEH"}},{"id":"R32_10","t1":{"src":"1G"},"t2":{"src":"3FHI"}},{"id":"R32_11","t1":{"src":"2G"},"t2":{"src":"2H"}}]},{"r":"32es de Finale","d":"03/07","matchups":[{"id":"R32_12","t1":{"src":"1H"},"t2":{"src":"3GIJ"}},{"id":"R32_13","t1":{"src":"1I"},"t2":{"src":"3HJK"}},{"id":"R32_14","t1":{"src":"2I"},"t2":{"src":"2J"}}]},{"r":"32es de Finale","d":"04/07","matchups":[{"id":"R32_15","t1":{"src":"1J"},"t2":{"src":"3IKL"}},{"id":"R32_16","t1":{"src":"2K"},"t2":{"src":"2L"}}]},{"r":"8es de Finale","d":"05/07","matchups":[{"id":"R16_1","t1":{"src":"WR32_1"},"t2":{"src":"WR32_2"}},{"id":"R16_2","t1":{"src":"WR32_3"},"t2":{"src":"WR32_4"}}]},{"r":"8es de Finale","d":"06/07","matchups":[{"id":"R16_3","t1":{"src":"WR32_5"},"t2":{"src":"WR32_6"}},{"id":"R16_4","t1":{"src":"WR32_7"},"t2":{"src":"WR32_8"}}]},{"r":"8es de Finale","d":"07/07","matchups":[{"id":"R16_5","t1":{"src":"WR32_9"},"t2":{"src":"WR32_10"}},{"id":"R16_6","t1":{"src":"WR32_11"},"t2":{"src":"WR32_12"}}]},{"r":"8es de Finale","d":"08/07","matchups":[{"id":"R16_7","t1":{"src":"WR32_13"},"t2":{"src":"WR32_14"}},{"id":"R16_8","t1":{"src":"WR32_15"},"t2":{"src":"WR32_16"}}]},{"r":"Quarts de Finale","d":"09/07","matchups":[{"id":"QF_1","t1":{"src":"WR16_1"},"t2":{"src":"WR16_2"}}]},{"r":"Quarts de Finale","d":"10/07","matchups":[{"id":"QF_2","t1":{"src":"WR16_3"},"t2":{"src":"WR16_4"}},{"id":"QF_3","t1":{"src":"WR16_5"},"t2":{"src":"WR16_6"}}]},{"r":"Quarts de Finale","d":"11/07","matchups":[{"id":"QF_4","t1":{"src":"WR16_7"},"t2":{"src":"WR16_8"}}]},{"r":"Demi-Finales","d":"14/07","matchups":[{"id":"SF_1","t1":{"src":"WQF_1"},"t2":{"src":"WQF_2"}}]},{"r":"Demi-Finales","d":"15/07","matchups":[{"id":"SF_2","t1":{"src":"WQF_3"},"t2":{"src":"WQF_4"}}]},{"r":"Match pour la 3e Place","d":"18/07","matchups":[{"id":"3RD","t1":{"src":"LSF_1"},"t2":{"src":"LSF_2"}}]},{"r":"FINALE 🏆","d":"19/07","matchups":[{"id":"FINAL","t1":{"src":"WSF_1"},"t2":{"src":"WSF_2"}}]}];
...
function resolveTeam(src, res, winners, losers) {
  ...
  m = src.match(/^3([A-L]+)$/);
  if (m) {
    for (const b of bestThirds(res)) if (m[1].includes(b.group)) return { name: b.team, q: true };
...
function koResults(res) {
  ...
  KO_MATCHES.forEach(day => day.matchups.forEach(mu => {
    const r = res['ko_' + mu.id];
    if (!r || r[0] === r[1]) return;
    const t1 = resolveTeam(mu.t1.src, res, winners, losers);
    const t2 = resolveTeam(mu.t2.src, res, winners, losers);
    if (t1.q && t2.q) {
...
async function list() {
  ...
  const { winners, losers } = koResults(res);
  KO_MATCHES.forEach(day => day.matchups.forEach(mu => {
    const key = 'ko_' + mu.id;
    if (res[key] || !lock[key] || now < lock[key]) return;
    const t1 = resolveTeam(mu.t1.src, res, winners, losers);
    const t2 = resolveTeam(mu.t2.src, res, winners, losers);
    if (t1.q && t2.q) pending.push({ key, match: `${t1.name} - ${t2.name}`, date: day.d, phase: day.r });
  }));
